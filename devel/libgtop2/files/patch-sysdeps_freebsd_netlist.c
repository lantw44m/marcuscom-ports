--- sysdeps/freebsd/netlist.c.orig	Wed Dec  1 13:00:43 2004
+++ sysdeps/freebsd/netlist.c	Wed Dec  1 13:01:57 2004
@@ -0,0 +1,65 @@
+/* $Id: patch-sysdeps_freebsd_netlist.c,v 1.1 2004-12-01 18:17:57 marcus Exp $ */
+
