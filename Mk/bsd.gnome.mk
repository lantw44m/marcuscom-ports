...
# GNOME 1 components
_USE_GNOME_ALL+= gdkpixbuf glib12 gnomelibs gtk12 libxml imlib orbit
...
orbit_LIB_DEPENDS=	libORBit.so:${PORTSDIR}/devel/ORBit
...
gnomelibs_LIB_DEPENDS=	libgnome.so:${PORTSDIR}/x11/gnome-libs
