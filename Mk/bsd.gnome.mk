...
atk_LIB_DEPENDS=	atk-1.0.900:${PORTSDIR}/accessibility/atk
...
gnomevfs2_LIB_DEPENDS=	gnomevfs-2.900:${PORTSDIR}/devel/gnomevfs2
...
libgnomecanvas_LIB_DEPENDS=	gnomecanvas-2.900:${PORTSDIR}/graphics/libgnomecanvas
...
libgnome_LIB_DEPENDS=	gnome-2.900:${PORTSDIR}/x11/libgnome
...
libgnomeui_LIB_DEPENDS=		gnomeui-2.900:${PORTSDIR}/x11-toolkits/libgnomeui
...
libwnck_LIB_DEPENDS=	wnck-1.14:${PORTSDIR}/x11-toolkits/libwnck
...
gtkhtml3_LIB_DEPENDS=	gtkhtml-3.6.16:${PORTSDIR}/www/gtkhtml3
...
evolutiondataserver_LIB_DEPENDS=edataserver-1.2.3:${PORTSDIR}/databases/evolution-data-server
