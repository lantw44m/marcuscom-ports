...
glib20_LIB_DEPENDS=	glib-2.0.305:${PORTSDIR}/devel/glib20
glib20_DETECT=		${LOCALBASE}/libdata/pkgconfig/glib-2.0.pc
glib20_USE_GNOME_IMPL=gnometarget pkgconfig

atk_LIB_DEPENDS=	atk-1.0.501:${PORTSDIR}/accessibility/atk
atk_DETECT=		${LOCALBASE}/libdata/pkgconfig/atk.pc
atk_USE_GNOME_IMPL=	glib20

pango_LIB_DEPENDS=	pango-1.0.305:${PORTSDIR}/x11-toolkits/pango
pango_DETECT=		${X11BASE}/libdata/pkgconfig/pango.pc
pango_USE_GNOME_IMPL=	glib20

gtk20_LIB_DEPENDS=	gtk-x11-2.0.305:${PORTSDIR}/x11-toolkits/gtk20
...
gnomevfs2_LIB_DEPENDS=	gnomevfs-2.500:${PORTSDIR}/devel/gnomevfs2
...
libgnomecanvas_LIB_DEPENDS=	gnomecanvas-2.590:${PORTSDIR}/graphics/libgnomecanvas
...
libgnome_LIB_DEPENDS=	gnome-2.590:${PORTSDIR}/x11/libgnome
...
libgnomeui_LIB_DEPENDS=		gnomeui-2.590:${PORTSDIR}/x11-toolkits/libgnomeui
...
eel2_LIB_DEPENDS=	eel-2.7:${PORTSDIR}/x11-toolkits/eel2
