...
pango_LIB_DEPENDS=	pango-1.0.700:${PORTSDIR}/x11-toolkits/pango
pango_DETECT=		${X11BASE}/libdata/pkgconfig/pango.pc
pango_USE_GNOME_IMPL=	glib20

gtk20_LIB_DEPENDS=	gtk-x11-2.0.506:${PORTSDIR}/x11-toolkits/gtk20
...
eel2_LIB_DEPENDS=	eel-2.11:${PORTSDIR}/x11-toolkits/eel2
...
gtkhtml3_LIB_DEPENDS=	gtkhtml-3.6.12:${PORTSDIR}/www/gtkhtml3
