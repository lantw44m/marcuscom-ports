...
# $FreeBSD$
#	$NetBSD: $
#     $MCom: ports/Mk/bsd.gnome.mk,v 1.299 2005/07/03 19:07:55 marcus Exp $
#
...
atk_LIB_DEPENDS=	atk-1.0.1011:${PORTSDIR}/accessibility/atk
atk_DETECT=		${LOCALBASE}/libdata/pkgconfig/atk.pc
atk_USE_GNOME_IMPL=	glib20

pango_LIB_DEPENDS=	pango-1.0.900:${PORTSDIR}/x11-toolkits/pango
pango_DETECT=		${X11BASE}/libdata/pkgconfig/pango.pc
pango_USE_GNOME_IMPL=	glib20

gtk20_LIB_DEPENDS=	gtk-x11-2.0.701:${PORTSDIR}/x11-toolkits/gtk20
...
gnomevfs2_LIB_DEPENDS=	gnomevfs-2.1100:${PORTSDIR}/devel/gnomevfs2
...
libgnomecanvas_LIB_DEPENDS=	gnomecanvas-2.1101:${PORTSDIR}/graphics/libgnomecanvas
...
libgnomeui_LIB_DEPENDS=		gnomeui-2.1100:${PORTSDIR}/x11-toolkits/libgnomeui
...
libwnck_LIB_DEPENDS=	wnck-1.17:${PORTSDIR}/x11-toolkits/libwnck
...
eel2_LIB_DEPENDS=	eel-2.13:${PORTSDIR}/x11-toolkits/eel
...
libgsf_gnome_LIB_DEPENDS=	gsf-gnome-1.13:${PORTSDIR}/devel/libgsf-gnome
...
gtkhtml3_LIB_DEPENDS=	gtkhtml-3.8.18:${PORTSDIR}/www/gtkhtml3
